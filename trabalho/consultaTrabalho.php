...
<body class="bg-light">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light navbar-style">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav">
                                ...
                                <a class="nav-link" id="navcolor" href="consultaTrabalho.php"><text class="selected">Trabalhos</text></a>
                            </div>
                        </div>
                    </nav>
                </div>
            ...
            <div class="col-4 text-end" style="vertical-align: middle;">
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="salvarTrabalho.php" method="POST" autocomplete="off">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="input-container">
                                        <div class="input-label">Descrição do Trabalho</div>
                                        <input type="text" name="descricao" placeholder="Informe a descrição do trabalho" required>
                                    </div>
                                </div>
                ...
                <a href="relatorioTrabalho.php" target="_blank">
    ...
    if (isset($_POST['pesquisa']) && !empty($_POST['pesquisa'])) {
        ...
        $sql = "SELECT COUNT(*) AS nroRegistros 
                  FROM trabalhos
                 WHERE UPPER(job_description) LIKE UPPER('%$pesquisa%')";
        ...
        $sql = "SELECT COUNT(*) AS nroRegistros FROM trabalhos";
        $result = mysqli_query($conn, $sql);
        $row = mysqli_fetch_assoc($result);
        $countRegistros = $row['nroRegistros'];

        $sql = "SELECT * FROM trabalhos LIMIT $inicio, $limite";
        $result = mysqli_query($conn, $sql);
    }
	?>
			...
			<div class="col-12" style="border: 1px solid #ddd; border-radius: 10px; box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">
				<table class="table table-striped" style="margin-top: 10px;">
					...
					<tbody>
						...
						?>
						<tr class="linha" ondblclick="document.location = 'alteraTrabalho.php?codigo=<?php echo $row[0]; ?>&descricao=<?php echo $row[1]; ?>'">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-danger" onclick="document.location = 'excluiTrabalho.php?codigo=<?php echo $row[0]; ?>'">Confirmar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="pagination">
                    <div class="pagination-controls">
                        <?php 
                        if ($inicio - $limite >= 0) { ?>
                            <form action="consultaTrabalho.php" method="POST" class="pagination-form">
