<?php
			...
			<table width='100%'>
				<tr>
					<td align='center' style='text-align: center; width: 100%;'>
						<div style='width: 100%;'>
							<font size='3'><b>RELATÓRIO DE TRABALHOS</b></font>
						</div>
					</td>
				</tr>
			</table>
	...
	$tabela = "<table width='100%'>
					...
					<thead>
						<tr>
							<th class='font-size' style='width: 100%;' align='left'><p>Trabalho</p></th>
						</tr>
					</thead>
	    			<tbody>";

	// monta query
	$sql = "SELECT job_description FROM trabalhos";
	$result = mysqli_query($conn, $sql);

	while ($row = mysqli_fetch_array($result, MYSQLI_NUM))
	{
		$tabela = $tabela."<tr>
						<td class='font-size' style='width: 100%;' align='left'>".$row[0]."</td>
					</tr>";
	}
	...
	$dompdf->set_option('title', 'Relatório de Trabalhos'); // Define o título do PDF
	...
	//Exibir a página
	$dompdf->stream("relatorio_trabalhos.pdf", 
	array(
