<?php
			...
			<table width='100%'>
				<tr>
					<td align='center' style='text-align: center; width: 100%;'>
						<div style='width: 100%;'>
							<font size='3'><b>RELATÓRIO DE BENEFÍCIOS</b></font>
						</div>
					</td>
				</tr>
			</table>
	...
	$tabela = "<table width='100%'>
					...
					<thead>
						<tr>
							<th class='font-size' style='width: 50%;' align='left'><p>Funcionário</p></th>
							<th class='font-size' style='width: 50%;' align='left'><p>Projeto</p></th>
						</tr>
					</thead>
	    			<tbody>";

	// monta query
	$sql = "SELECT f.emp_lname, p.plan_description FROM beneficios b, funcionarios f, projetos p WHERE b.emp_code = f.emp_code AND b.plan_code = p.plan_code ORDER BY f.emp_lname";
	...
	$dompdf->set_option('title', 'Relatório de Benefícios'); // Define o título do PDF
	...
	//Exibir a página
	$dompdf->stream("relatorio_beneficios.pdf", 
	array(
