...
CREATE TABLE `beneficios` (
  ...
  CONSTRAINT `emp_code` FOREIGN KEY (`emp_code`) REFERENCES `funcionarios` (`emp_code`),
  CONSTRAINT `plan_code` FOREIGN KEY (`plan_code`) REFERENCES `projetos` (`plan_code`)
...
INSERT INTO `beneficios` VALUES (8,1),(10,1),(6,2),(8,2),(13,2),(2,3),(8,8),(6,9),(2,10),(6,10);
