<?php 
    $codigo = $_GET['codigo'];
    $nome = $_GET['nome'];
    $codigoTrabalho = $_GET['codigoTrabalho'];
    ...
    <body>
        <center>
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <form action="alteraUpdateFuncionario.php" method="POST" autocomplete="off">
                            <div style="text-align: left;">Código</div>
                            <input type="text" name="codigo" value="<?php echo $codigo ?>" readonly>
                            <br><br>
                            <div style="text-align: left;">Nome do Funcionário</div>
                            <input type="text" name="nome" value="<?php echo $nome ?>" required>
                            <br><br>
                            <div style="text-align: left;">Trabalho</div>
                            <select class="form-control" name="codTrabalho">
                                <option value="<?php echo $codigoTrabalho ?>" selected><?php echo $trabalho ?></option>
                                <?php 
                                // conexão
            ...
            <div class="container py-3">
                <div class="row">
                    <div class="col-12">
                        <center>
                            <a href="consultaFuncionario.php">
