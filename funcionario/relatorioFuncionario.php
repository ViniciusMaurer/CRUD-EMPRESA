<?php
			...
			<table width='100%'>
				<tr>
					<td align='center' style='text-align: center; width: 100%;'>
						<div style='width: 100%;'>
							<font size='3'><b>RELATÓRIO DE FUNCIONÁRIOS</b></font>
						</div>
					</td>
				</tr>
			</table>
	...
	$tabela = "<table width='100%'>
					...
					<thead>
						<tr>
							...
							<th class='font-size' style='width: 50%;' align='left'><p>Trabalho</p></th>
						</tr>
					</thead>
	    			<tbody>";

	// monta query
	$sql = "SELECT f.emp_lname, t.job_description FROM funcionarios f, trabalhos t WHERE f.job_code = t.job_code ORDER BY f.emp_lname";
	...
	$dompdf->set_option('title', 'Relatório de Funcionários'); // Define o título do PDF
	...
	//Exibir a página
	$dompdf->stream("relatorio_funcionarios.pdf", 
	array(
