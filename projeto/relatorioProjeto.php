<?php
			...
			<table width='100%'>
				<tr>
					<td align='center' style='text-align: center; width: 100%;'>
						<div style='width: 100%;'>
							<font size='3'><b>RELATÓRIO DE PROJETOS</b></font>
						</div>
					</td>
				</tr>
			</table>
	...
	$tabela = "<table width='100%'>
					...
					<thead>
						<tr>
							<th class='font-size' style='width: 100%;' align='left'><p>Projeto</p></th>
						</tr>
					</thead>
	    			<tbody>";

	// monta query
	$sql = "SELECT plan_description FROM projetos";
	...
	$dompdf->set_option('title', 'Relatório de Projetos'); // Define o título do PDF
	...
	//Exibir a página
	$dompdf->stream("relatorio_projetos.pdf", 
	array(
