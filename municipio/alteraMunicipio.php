    ...
    <body>
        <center>
            <div class="container">
                <div class="row">
                    <div class="col-12">
                        <form action="alteraUpdateMunicipio.php" method="POST" autocomplete="off">
                            <div style="text-align: left;">Código</div>
                            <input type="text" name="codigo" value="<?php echo $codigo ?>" readonly>
                            <br><br>
                            <div style="text-align: left;">Nome do Município</div>
