...
<head>
    <meta charset="UTF-8">
    <title>Consulta - Município</title>
...
<body class="bg-light">
                    ...
                    <nav class="navbar navbar-expand-lg navbar-light navbar-style">
                        ...
                        <div class="collapse navbar-collapse" id="navbarNavAltMarkup">
                            <div class="navbar-nav">
                                ...
                                <a class="nav-link" id="navcolor" href="consultaMunicipio.php"><text class="selected">Municípios</text></a>
            ...
            <div class="col-4 text-end" style="vertical-align: middle;">
                ...
                <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                    <div class="modal-dialog">
                        <form action="salvarMunicipio.php" method="POST" autocomplete="off">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="input-container">
                                        <div class="input-label">Nome do Município</div>
                                        <input type="text" name="cidade" placeholder="Informe o nome da cidade" required>
                                    </div>
                ...
                <a href="relatorioMunicipio.php" target="_blank">
    ...
    if (isset($_POST['pesquisa']) && !empty($_POST['pesquisa'])) {
        ...
        $sql = "SELECT COUNT(*) AS nroRegistros 
                  FROM municipios
                 WHERE UPPER(cidade) LIKE UPPER('%$pesquisa%') OR UPPER(uf) LIKE UPPER('%$pesquisa%')";
        ...
        $sql = "SELECT COUNT(*) AS nroRegistros FROM municipios";
        $result = mysqli_query($conn, $sql);
        $row = mysqli_fetch_assoc($result);
        $countRegistros = $row['nroRegistros'];
        
        $sql = "SELECT * FROM municipios LIMIT $inicio, $limite";
        $result = mysqli_query($conn, $sql);
    }
            ...
            <div class="col-12" style="border: 1px solid #ddd; border-radius: 10px; box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">
                <table class="table table-striped" style="margin-top: 10px;">
                    ...
                    <tbody>
                        <?php while ($row = mysqli_fetch_array($result, MYSQLI_NUM)) { ?>
                            <tr class="linha" ondblclick="document.location = 'alteraMunicipio.php?codigo=<?php echo $row[0]; ?>&cidade=<?php echo $row[1]; ?>&uf=<?php echo $row[2]; ?>'">
                                ...
                                <div class="modal-dialog" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button type="button" class="btn btn-danger" onclick="document.location = 'excluiMunicipio.php?codigo=<?php echo $row[0]; ?>'">Confirmar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="pagination">
                    <div class="pagination-controls">
                        <?php 
                        if ($inicio - $limite >= 0) { ?>
                            <form action="consultaMunicipio.php" method="POST" class="pagination-form">
    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-12 text-info">
                <h1><b>ANÁLISE MUNICÍPIOS POR ESTADO</b></h1>
            </div>
        </div>
    </div>
    <div class="container mb-5 bg-white">
		<div class="row">
			<div class="col-12" style="border: 1px solid #ddd; border-radius: 10px; box-shadow: rgba(0, 0, 0, 0.16) 0px 3px 6px, rgba(0, 0, 0, 0.23) 0px 3px 6px;">
                <?php
                include('graficoMunicipioEstado.php');
                ?>
            </div>
        </div>
    </div>
